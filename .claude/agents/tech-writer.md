---
name: tech-writer
description: Technical documentation specialist for VHP. Use PROACTIVELY after implementing features to keep README.md, AGENTS.md, and docs/ folder synchronized with the codebase. Also use when the user asks about documentation, installation, usage, features, roadmap, or contribution guidelines.
