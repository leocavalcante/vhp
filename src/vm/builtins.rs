...
pub fn call_builtin<W: Write>(name: &str, args: &[Value], output: &mut W) -> Result<Value, String> {
    ...
    match lower_name.as_str() {
        ...
        "fmod" => builtins::math_extra::fmod(args),
        "intdiv" => builtins::math_extra::intdiv(args),
        ...
        "getrandmax" => builtins::math_extra::getrandmax(args),
        "mt_getrandmax" => builtins::math_extra::mt_getrandmax(args),
        "lcg_value" => builtins::math_extra::lcg_value(args),
        "srand" => builtins::math_extra::srand(args),
        "mt_srand" => builtins::math_extra::mt_srand(args),
